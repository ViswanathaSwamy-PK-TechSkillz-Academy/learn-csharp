...
## X. Create a New Console Project (C#), Class Library (VB) and them to the solution S2

### X.X. Creating a New Console Project (C#) and add it to the solution S2
...
### X.X. Creating a New Class Library (VB) and add it to the solution S2
...
## X. Executing three Console Project(s)
