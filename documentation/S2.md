...
> 1. Modify the MathServicesVBLib Library and add it to the ProgramStructureDemoV3 Project
> 1. - Modify the MathServicesVBLib Library
> 1. - Add MathServicesVBLib Library reference to the ProgramStructureDemoV3 Project
...
## 6. 30,000 foot view of "How it was possible to use VB.NET Library in C# Project?"
...
## 7. 30,000 foot view of "What is Common Language Infrastructure?"
...
## 8. Understanding "JIT Compilation" Process
