...
> 1. Discussion and demo
> 1. Create a folder named `net6demoappv1` and open the folder in VS Code Terminal / Terminal
> 1. Run the below commands

```powershell
dotnet new globaljson --sdk-version 6.0.414 -o ./net6demoappv1
...
> 1. Discussion and demo
> 1. Create a folder named `net7demoappv1` and open the folder in VS Code Terminal / Terminal
> 1. Run the below commands

```powershell
dotnet new globaljson --sdk-version 7.0.401 -o ./net7demoappv1
