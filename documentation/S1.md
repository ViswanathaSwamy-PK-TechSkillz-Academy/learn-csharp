...
> 1. What is .NET?
> 1. .NET History
> 1. 30,000 foot view of .NET Common Language Runtime (CLR), BCL, CoreCLR, CoreFX basics
> 1. C# Language
> 1. Exploring few basic .NET CLI commands, Project Templates
> 1. Preparing Workspace, Solution, Project(s)
...
## 6. Preparing Workspace, Solution, Project(s)
